 ...
 * - 按键提示
 */
public class TelemetryManager_2_0 {
    
    private final Telemetry telemetry;
    
    public TelemetryManager_2_0(Telemetry telemetry) {
    ...
    public void displayShooterStatus(int targetRPM, double currentRPM, 
        ...
        String fireStateStr;
        switch (fireState) {
            case RobotConstants_2_0.STATE_IDLE:
                fireStateStr = "待机";
                break;
            case RobotConstants_2_0.STATE_PREPARING:
                fireStateStr = "准备中";
                break;
            case RobotConstants_2_0.STATE_READY_TO_FIRE:
                fireStateStr = "准备好";
                break;
            case RobotConstants_2_0.STATE_FIRING:
                fireStateStr = "发射中";
                break;
            default:
                fireStateStr = "未知";
