...
/**
 * 底盘驱动系统 v2.0.0 - Mecanum 轮驱动和运动控制
 * 
 * 功能：
 * - 前后、左右、旋转独立控制
 * - 自动转向时禁用手动转向
 ...
 * - 功率归一化
 */
public class ChassisDriveSystem_2_0 {
    ...
    // 控制参数
    private final double DEADZONE = RobotConstants_2_0.CHASSIS_JOYSTICK_DEADZONE;
    
    /**
     * 构造函数
     */
    public ChassisDriveSystem_2_0(DcMotor fl, DcMotor fr, DcMotor bl, DcMotor br) {
