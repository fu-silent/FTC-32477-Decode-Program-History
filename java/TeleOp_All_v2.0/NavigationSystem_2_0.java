 ...
 * - 重置 IMU 偏航角
 */
public class NavigationSystem_2_0 {
    ...
    // 配置参数（从常数获取）
    private final double HEADING_THRESHOLD = RobotConstants_2_0.AUTO_TURN_HEADING_THRESHOLD;
    private final double TURN_POWER = RobotConstants_2_0.AUTO_TURN_POWER;
    private final double P_GAIN = RobotConstants_2_0.AUTO_TURN_P_GAIN;
    private final double I_GAIN = RobotConstants_2_0.AUTO_TURN_I_GAIN;
    private final double D_GAIN = RobotConstants_2_0.AUTO_TURN_D_GAIN;
