...
/**
 * FTC32477 TeleOp v2.0.0 - 常数和配置管理
 * 
 * 新增功能：
 * - IMU 自动转向控制
 * - 双发射电机独立控制
 * - 多转速档位预设
 */
public class RobotConstants_2_0 {
    ...
    // 转速精度范围（RPM）
    public static final int SHOOTER_RPM_ERROR_RANGE_LONG = 30;      // 超远精度范围
    public static final int SHOOTER_RPM_ERROR_RANGE_SIDE = 50;      // 腰部精度范围
    public static final int SHOOTER_RPM_ERROR_RANGE_BASE = 150;     // 底部精度范围
    public static final int SHOOTER_RPM_ERROR_RANGE_TOP = 35;       // 顶点精度范围
