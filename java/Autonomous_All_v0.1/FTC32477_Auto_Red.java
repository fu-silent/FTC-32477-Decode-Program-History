 ...
 * 
 * @author FTC32477
 * @version 1.0 - 红方自动阶段控制
 */
@Autonomous(name = "FTC32477 Auto Red", group = "Autonomous")
public class FTC32477_Auto_Red extends LinearOpMode {
    ...
    private void runAutonomousPath() {
        telemetry.addData("状态", "开始执行自动路径（红方）");
        telemetry.update();
    ...
    private void executeLeftPath() {
        telemetry.addData("路径", "执行左侧路径（红方）");
        telemetry.update();
    ...
    private void executeCenterPath() {
        telemetry.addData("路径", "执行中央路径（红方）");
        telemetry.update();
    ...
    private void executeRightPath() {
        telemetry.addData("路径", "执行右侧路径（红方）");
        telemetry.update();
