...
/**
 * TeleOp v3.0.3 Blue (修复IMU resetYaw兼容性问题)
 * * 职能划分：
 * - Driver 1 (主驾驶/全能):
 ...
 */
@TeleOp(name = "TeleOp_All_3_0_Blue", group = "TeleOp")
public class TeleOp_All_3_0_Blue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Driver 1", "A=45°大三角区, B=66°超远, RT=拾取, LB=反转拾取, LT=装填");
