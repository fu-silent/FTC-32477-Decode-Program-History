...
@Autonomous(name = "Auto_Red_Far_Leave_Q43_19705", group = "Autonomous")
public class Auto_Red_Far_Leave_Q43_19705 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        moveStraightVelocity(-150, 0, 0.5, 0.22, 2.0);

        sleep(19000);

        strafePID(600, 0, 0.5, 4.0);

        // moveStraightVelocity(-25, 0, 0.5, 0.1, 2.0);
