...
@Autonomous(name = "Auto_Red_Near_Shoot1_3_0", group = "Autonomous")
public class Auto_Red_Near_Shoot1_3_0 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        moveStraightVelocity(-550, 0, 0.8, 0, 0.65);

        // 发射 (1225 RPM, 持续 2 秒)
        shootVelocity(1225, 2);

        // 旋转 35 度
        rotateVelocity(-35, 0.5, 2.5);

        // 向左平移 200mm
        strafePID(200, -45, 0.8, 1.25);

        // 前进的同时吸球
        moveStraightWithSubsystems(450,-35,0.5,0.1,3,1.5,0.5,3);

        moveStraightVelocity(-200, -35, 0.5, 0.22, 0.5);

        strafePID(-200, -35, 0.8, 1.25);

        // 转向
        rotateVelocity(0, 0.5, 2.0);

        // 第一组球的射出
        shootVelocity(1300, 2.0);

        // 转向
        rotateVelocity(-35, 0.5, 2.0);

        strafePID(475, -45, 0.8, 1.25);

        // 前进的同时吸球
        moveStraightWithSubsystems(550,-35,0.5,0.1,3,2,0.5,3);

        moveStraightVelocity(-200, -35, 0.5, 0.22, 0.7);

        strafePID(-550, -35, 0.8, 1.25);
        ...
        strafePID(800, -45, 0.5, 3.0);

        // 前进的同时吸球
        moveStraightWithSubsystems(600,-40,0.7,0.1,3,2,0.5,3);
