...
/**
 * TeleOp v2.3.0 Blue - 蓝队版本
 * - 自动转向目标：-45度 (顺时针/向右)
 *   注意：在FTC坐标系中，通常逆时针为正，顺时针为负。
 *   Blue版本将 AUTO_TURN_TARGET_RIGHT 修改为 -45.0
 */
@TeleOp(name = "TeleOp_All_2_3_Blue", group = "TeleOp")
public class TeleOp_All_2_3_Blue extends LinearOpMode {
    ...
    class Constants {
        ...
        final double AUTO_TURN_TARGET_RIGHT = -45.0; // 蓝队目标角度：顺时针45度
    ...
    class TelemetryDisplay {
        void displayFull(String runtime, int targetRPM, double s1RPM, double s2RPM,
            ...
            telemetry.addLine("========== TeleOp v2.3 Blue ==========");
    ...
    public void runOpMode() {
        ...
        telemetry.addData("状态", "准备就绪 (v2.3 Blue 无头模式集成)");
        telemetry.update();
